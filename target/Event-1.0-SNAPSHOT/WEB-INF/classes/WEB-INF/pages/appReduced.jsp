        ...
        <div align="right">
            <c:if test = "${pageContext.request.remoteUser != null}" >
                ...
                <sf:form action="${contextPath}/logout" method="post">
                    <button type= "submit" class="button"><st:message code="button.exit"/>t</button>
                </sf:form>
            ...
            <form  action="/app" method="get">
                <st:message code="message.dateOrder"/><br/><button type="submit" class="button"><st:message code="button.show"/></button>
            </form>

            <form  action="/appSortByNoteTime" method="get">
                <st:message code="message.datePublish"/><br/><button type="submit" class="button"><st:message code="button.show"/></button>
            </form>
